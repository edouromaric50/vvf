...
class _HomePageState extends ConsumerState<HomePage>
  ...
  Widget build(BuildContext context) {
    ...
    var menus = [
      ["money.png", "Caisses", Colors.amber, Container()],
      ["closures.png", "Projets", Colors.green, Container()],
      ["categories.png", "Categories", Colors.blue, Container()],
      [
        "settings.png",
        "Parametre",
        Color.fromARGB(255, 89, 253, 206),
        Container()
      ],
    ];
    return Scaffold(
